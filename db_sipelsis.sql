...
INSERT INTO `TB_PELANGGARAN` (`IDPELANGGARAN`, `IDKATEGORI`, `NAMA_PELANGGARAN`) VALUES
(1, 1, 'Atribut Tidak Lengkap'),
(2, 1, 'Terlambat Datang ke Sekolah'),
(3, 2, 'Bolos Sekolah'),
(4, 2, 'Kabur Saat KBM'),
(5, 3, 'Merokok di Lingkungan Sekolah'),
(6, 3, 'Berkelahi Dengan Teman');
...
--
ALTER TABLE `TB_PELANGGARAN`
  MODIFY `IDPELANGGARAN` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=700004;
COMMIT;
