              ...
              <div class="animated flipInY col-lg-12 col-md-12 col-sm-6 col-xs-12">
                  ...
                  <div class="x_content">
                    ...
                    <form id="demo-form2" data-parsley-validate="" class="form-horizontal form-label-left" novalidate="">
                      ...
                      <div class="form-group">
                        <label for="middle-name" class="control-label col-md-3 col-sm-3 col-xs-12">Nomer Absensi</label>
                        <div class="col-md-6 col-sm-6 col-xs-12">
                      ...
                      <div class="form-group">
                        <label class="control-label col-md-3 col-sm-3 col-xs-12">Jenis Pelanggaran</label>
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <select class="form-control">
