            ...
            <div class="row">
              <div class="col-md-12 col-sm-12 col-xs-12">
                ...
                ?>
                    ...
                    <form action="<?php echo base_url(); ?>index.php/admin/updateadmin/<?php echo $admin->IDADMIN;?>" method="post" enctype="multipart/form-data" id="demo-form2" data-parsley-validate class="form-horizontal form-label-left">
                      ...
                      <p>
                        Admin : 
                        <input type="radio" class="flat"  name="ROLE" id="ROLE" required="required" value="Admin" <?php echo ($admin->ROLE == 'Admin')?'checked':'' ?> />
                      </p>
                      </div>
                      </div>
